...
- Active Directory attack chains and detection engineering
- Network and service enumeration (HTB CPTS path)
- SIEM engineering — Splunk SPL and Microsoft Sentinel KQL
- Threat hunting and malware triage
- Python tooling for offensive and defensive operations
